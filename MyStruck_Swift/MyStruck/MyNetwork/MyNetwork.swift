...
class MyNetwork: NSObject {
    ...
    @discardableResult final class func my_asyncRequest(withUrl url:String,
    ...
    ///   - httpError: http request error
    /// - Returns: return value description
    @discardableResult class func my_uploadImage(to url:String!,
                                                 images:Array<Data>!,
                                                 params:Dictionary<String,Any>?,
                                                 completion:ZXHTTPCompletionAction?,
                                                 timeOut:ZXHTTPTimeOutAction?,
    ...
    @discardableResult class func my_fileupload(to url:String!,
                                                name:String,
                                                fileName:String,
                                                mimeType:String,
                                                fileData:Data,
